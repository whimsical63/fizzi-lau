...
const Hero = ({slice}: HeroProps): JSX.Element => {
    ...
    useGSAP(() => {
        if(!ready && isDesktop) return; // can i start this animation?
    ...
    }, {dependencies: [ready, isDesktop]}); //Add ready to the dependencies so useGSAP will only run when the value changes
